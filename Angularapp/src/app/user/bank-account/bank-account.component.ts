        ...
        if (res == [])
          ...
          (res as []).forEach((bankAccount: any) => {
            this.bankAccountForms.push(this.fb.group({
              ...
              companyName: [bankAccount.companyName, Validators.required],
              companyBusiness: [bankAccount.companyBusiness, Validators.required],
              designation: [bankAccount.designation, Validators.required],
              department: [bankAccount.department, Validators.required],
              startdate: [bankAccount.startdate, Validators.required],
              
              endDate: [bankAccount.endDate, Validators.required]
            }));
          });
        }
      }
